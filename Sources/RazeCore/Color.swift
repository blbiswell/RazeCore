...
extension RazeCore {
    ...
    public class Color {
        ...
        /// Allows you to converta 6 digit hexadecimal string into a UIColor instance
        ...
        /// The most eye-pleasing color based on some developer's input
        public static var razeColor: UIColor {
            return self.fromHexString("006736")
        }
        
        
        /// Returns an object of `UIColor` with a secondary pleasing color.
